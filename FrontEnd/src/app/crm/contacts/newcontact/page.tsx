            ...
            {formType === "New Contact" ? (
                ...
                <form onSubmit={handleSubmitContact}>
                    ...
                    <div className="flex justify-end w-full">
                        <RoundedButton color={isContactFormValid() ? "green" : "red"} text="Submit" Icon={Check} link="/crm/contacts" />  {/*TODO: aqui falta el onChange(setNewContact) que se implementará después*/}
                    </div>
                </form>
            ) : (
                ...
                <form onSubmit={handleSubmitEnterprise}>
                    ...
                    <div className="flex justify-end w-full">
                        <RoundedButton color={isEnterpriseFormValid() ? "green" : "red"} text="Submit" Icon={Check} link="/crm/contacts" /> {/*TODO: aqui falta el onChange(setNewEnterprise) que se implementará después*/}
                    </div>
                </form>
            )}
        </main>
