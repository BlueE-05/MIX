...
import ArrowRightButton from "@/components/Buttons/ArrowRightButton"; // Import the ArrowRightButton component
...
export default function SalesPage() {
  ...
  const salesData = Array.from({ length: 25 }, (_, i) => {
    ...
    return [
      ...
      closingDate,
      creationDate,
      <ArrowRightButton /> // Agregar el botón de la flecha
    ];
  });
