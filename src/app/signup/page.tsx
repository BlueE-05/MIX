...
import { teams, educationLevels, fieldLabels, passwordRegex, emailRegex, phoneRegex, birthDateRange } from "../constants/SignUp/formFields";
...
export default function SignupForm({ onSubmit }: SignupFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (isStepValid()) onSubmit(e, formData);
    };
